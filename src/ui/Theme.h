#ifndef FOLDERSWITCH_THEME_H
#define FOLDERSWITCH_THEME_H
...
// Tokens visuales de la app (tema oscuro LGA) y la hoja de estilo global. Copia recortada del
// Theme de LGA_VideoDownloader (include/videodownloader/theme.h): mismos valores, para que las
// dos apps se vean de la misma familia. Todo color o medida de la UI sale de aca; los widgets
// solo eligen objectName y propiedades.
namespace Theme {
