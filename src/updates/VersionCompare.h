...
// Comparacion de versiones de FolderSwitch. Fuente unica de verdad para decidir si el tag de
// un release es mas nuevo que la version instalada (FOLDERSWITCH_VERSION).
//
// Compara NUMERICAMENTE POR SEGMENTO: 0.10 > 0.9 > 0.1, y 0.11 > 0.10. FolderSwitch numera
